export default function ResumeBuilder() {
  return (
    <section className="container py-10 md:py-14">
      ...
      {/* Form */}
      <form className="mt-8 grid gap-6 md:grid-cols-2" aria-labelledby="personal-info">
        <fieldset className="md:col-span-2">
          <legend id="personal-info" className="sr-only">Personal Information</legend>
        ...
        <fieldset className="md:col-span-2 rounded-2xl border bg-secondary/40 p-6">
