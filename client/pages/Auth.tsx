      ...
      <div className="container grid items-center justify-center gap-8 md:grid-cols-2">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <p className="mt-2 max-w-md text-white/80">
            Sign in to continue or create a new account. You can switch between Login and Signup at any time.
          </p>
          <div className="mt-6 hidden md:block">
            <div className="relative overflow-hidden rounded-2xl border bg-white/5 p-6 backdrop-blur">
              ...
              <p className="text-sm text-white/80">
                Build resumes, portfolios, and pitches with beginner‑friendly tools. Save progress locally and export anytime.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="relative overflow-hidden rounded-2xl border bg-card p-6 shadow-xl">
            ...
            <Tabs value={mode} onValueChange={(v) => setMode(v as any)}>
              <TabsList className="w-full justify-center gap-2 bg-transparent p-0 text-foreground">
                <TabsTrigger value="login" className="rounded-full bg-muted/60 px-4 py-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Login</TabsTrigger>
                <TabsTrigger value="signup" className="rounded-full bg-muted/60 px-4 py-2 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Signup</TabsTrigger>
              </TabsList>
...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden focusable="false">
      <path fill="#FFC107" d="M43.611,20.083H42V20H24v8h11.303C33.676,32.91,29.229,36,24,36c-6.627,0-12-5.373-12-12 s5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,4,24 s8.955,20,20,20s20-8.955,20-20C44,22.659,43.862,21.35,43.611,20.083z"/>
      <path fill="#FF3D00" d="M6.306,14.691l6.571,4.819C14.655,16.128,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657 C34.046,6.053,29.268,4,24,4C16.318,4,9.656,8.337,6.306,14.691z"/>
      <path fill="#4CAF50" d="M24,44c5.166,0,9.86-1.977,13.409-5.197l-6.191-5.238C29.162,35.091,26.715,36,24,36 c-5.202,0-9.636-3.064-11.386-7.431l-6.54,5.036C9.393,39.556,16.13,44,24,44z"/>
      <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-1.009,2.909-3.137,5.266-5.894,6.565 c0.001-0.001,0.002-0.001,0.003-0.002l6.191,5.238C33.3,40.104,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"/>
    </svg>
  );
}
